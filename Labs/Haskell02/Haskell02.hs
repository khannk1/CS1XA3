...
--identifier = identifier :: Parser String
identifier = do { k <- many alphaNum;
                  return k } -- #TODO replace me
...
--items p = return [] -- #TODO replace me
--items :: Parser (String,Integer) -> Parser [(String,Integer)]
items p = do { char '{';
               xs <- sepBy p (symbol ",");
               char '}';
...
--intDict = return [] -- #TODO replace me
--intDict :: Parser [(String,Integer)]
--intDict :: Parser [(String,Integer)]
